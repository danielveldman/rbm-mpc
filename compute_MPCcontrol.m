function [uMPC, XMPC, duration] = compute_MPCcontrol(A, X0, B, u0, Q, R, xd, tgrid, Mass, T, tau)
...
while ind1 < nt
    ...
    uii = compute_control(A, XMPC(:,ind1), B, u0(:,1:ind2-ind1), Q, R, xd, tgrid(ind1:ind2), Mass);
